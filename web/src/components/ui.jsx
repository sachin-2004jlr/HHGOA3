...
const PATHS = {
  face: ["M12 13.5a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9Z", "M4.5 20.5c1.4-3.4 4.2-5.2 7.5-5.2s6.1 1.8 7.5 5.2"],
  ...
  shield: ["M12 3 5 6v5c0 4.5 3 8.4 7 10 4-1.6 7-5.5 7-10V6z", "m9 12 2 2 4-4"],
